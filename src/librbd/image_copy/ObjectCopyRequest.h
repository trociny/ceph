...
#ifndef CEPH_LIBRBD_IMAGE_COPY_OBJECT_IMAGE_COPY_REQUEST_H
#define CEPH_LIBRBD_IMAGE_COPY_OBJECT_IMAGE_COPY_REQUEST_H
...
extern template class librbd::image_copy::ObjectCopyRequest<librbd::ImageCtx>;

#endif // CEPH_LIBRBD_IMAGE_COPY_OBJECT_IMAGE_COPY_REQUEST_H
