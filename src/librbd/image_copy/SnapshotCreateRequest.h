...
#ifndef CEPH_LIBRBD_IMAGE_COPY_SNAPSHOT_CREATE_REQUEST_H
#define CEPH_LIBRBD_IMAGE_COPY_SNAPSHOT_CREATE_REQUEST_H
...
extern template class librbd::image_copy::SnapshotCreateRequest<librbd::ImageCtx>;

#endif // CEPH_LIBRBD_IMAGE_COPY_SNAPSHOT_CREATE_REQUEST_H
