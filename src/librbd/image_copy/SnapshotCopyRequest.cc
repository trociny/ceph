...
#undef dout_prefix
#define dout_prefix *_dout << "librbd::image_copy::SnapshotCopyRequest: " \
                           << this << " " << __func__ << ": "
...
void SnapshotCopyRequest<I>::handle_snap_create(int r) {
  ...
  auto snap_it = m_dst_image_ctx->snap_ids.find({cls::rbd::UserSnapshotNamespace(),
						   m_snap_name});
...
template class librbd::image_copy::SnapshotCopyRequest<librbd::ImageCtx>;
