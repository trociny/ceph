...
void AttachChildRequest<I>::handle_v1_refresh(int r) {
  ...
  if (r == 0) {
    ...
    r = m_parent_image_ctx.is_snap_protected(m_parent_snap_id, &snap_protected);
...
void AttachChildRequest<I>::v2_set_op_feature() {
  ...
  auto aio_comp = create_rados_callback<
      ...
      &AttachChildRequest<I>::handle_v2_set_op_feature>(this);
...
void AttachChildRequest<I>::v2_child_attach() {
  ...
  auto aio_comp = create_rados_callback<
      AttachChildRequest<I>,
      &AttachChildRequest<I>::handle_v2_child_attach>(this);
