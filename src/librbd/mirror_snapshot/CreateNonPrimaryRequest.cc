...
#include "librbd/mirror_snapshot/CreateNonPrimaryRequest.h"
...
#undef dout_prefix
#define dout_prefix *_dout << "librbd::mirror_snapshot::CreateNonPrimaryRequest: " \
                           << this << " " << __func__ << ": "
...
template class librbd::mirror_snapshot::CreateNonPrimaryRequest<librbd::ImageCtx>;
