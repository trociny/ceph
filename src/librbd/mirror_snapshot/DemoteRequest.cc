...
#include "librbd/mirror_snapshot/DemoteRequest.h"
...
#undef dout_prefix
#define dout_prefix *_dout << "librbd::mirror_snapshot::DemoteRequest: " \
                           << this << " " << __func__ << ": "
...
template class librbd::mirror_snapshot::DemoteRequest<librbd::ImageCtx>;
