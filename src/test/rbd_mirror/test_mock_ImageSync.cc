...
public:
  ...
  static DeepCopyRequest* create(librbd::MockTestImageCtx *src_image_ctx,
...
public:
  ...
  void expect_set_sync_point_snap_contex(
      librbd::MockTestImageCtx &mock_remote_image_ctx, int r) {
    expect_snap_set(mock_remote_image_ctx, "snap1", r);
  }
  ...
  void expect_unset_sync_point_snap_contex(
      librbd::MockTestImageCtx &mock_remote_image_ctx, int r) {
    expect_snap_set(mock_remote_image_ctx, "", r);
  }
...
TEST_F(TestMockImageSync, SimpleSync) {
  ...
  expect_set_sync_point_snap_contex(mock_remote_image_ctx, 0);
  expect_copy_image(mock_image_copy_request, 0);
  expect_unset_sync_point_snap_contex(mock_remote_image_ctx, 0);
