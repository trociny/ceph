...
#include "librbd/mirror_snapshot/UnlinkPeerRequest.cc"
template class librbd::mirror_snapshot::UnlinkPeerRequest<librbd::MockTestImageCtx>;
    ...
    EXPECT_CALL(get_mock_io_ctx(mock_image_ctx.md_ctx),
      ...
      .WillOnce(Invoke([&mock_image_ctx, snap_id, peer_uuid, r](auto&&... args) -> int {
                         if (r == 0) {
                           ...
                           EXPECT_NE(0, info->mirror_peers.erase(peer_uuid));
                         }
                         return r;
                       }));
  }
