...
public:
  ...
  void check_mirror_image_enable(
      ...
      rbd_mirror_image_mode_t mirror_image_mode = RBD_MIRROR_IMAGE_MODE_UNKNOWN) {
    ...
    if (mirror_image_mode != RBD_MIRROR_IMAGE_MODE_UNKNOWN) {
...
TEST_F(TestMirroring, Snapshot)
{
  ...
  ASSERT_EQ(0, image.snap_get_mirror_primary_namespace(snap_id, &mirror_snap,
                                                       sizeof(mirror_snap)));
  ASSERT_EQ(1U, mirror_snap.mirror_peers.size());
  ASSERT_EQ(1, mirror_snap.mirror_peers.count(peer_uuid));
...
TEST_F(TestMirroring, SnapshotUnlinkPeer)
{
  ...
  ASSERT_EQ(0, image.snap_get_mirror_primary_namespace(snap_id, &mirror_snap,
                                                       sizeof(mirror_snap)));
  ASSERT_EQ(3U, mirror_snap.mirror_peers.size());
  ASSERT_EQ(1, mirror_snap.mirror_peers.count(peer1_uuid));
  ASSERT_EQ(1, mirror_snap.mirror_peers.count(peer2_uuid));
  ASSERT_EQ(1, mirror_snap.mirror_peers.count(peer3_uuid));
  ...
  C_SaferCond cond1;
  auto req = librbd::mirror_snapshot::UnlinkPeerRequest<>::create(
  ...
  ASSERT_EQ(0, image.snap_get_mirror_primary_namespace(snap_id, &mirror_snap,
                                                       sizeof(mirror_snap)));
  ASSERT_EQ(2U, mirror_snap.mirror_peers.size());
  ASSERT_EQ(1, mirror_snap.mirror_peers.count(peer2_uuid));
  ASSERT_EQ(1, mirror_snap.mirror_peers.count(peer3_uuid));
  ...
  C_SaferCond cond2;
  req = librbd::mirror_snapshot::UnlinkPeerRequest<>::create(
...
TEST_F(TestMirroring, SnapshotImageState)
{
  ...
  {
    C_SaferCond cond;
    auto req = librbd::mirror_snapshot::SetImageStateRequest<>::create(
      ictx, 123, &cond);
    req->send();
    ASSERT_EQ(0, cond.wait());
  }

  librbd::mirror_snapshot::ImageState image_state;
  {
    C_SaferCond cond;
    auto req = librbd::mirror_snapshot::GetImageStateRequest<>::create(
  ...
  {
    C_SaferCond cond;
    auto req = librbd::mirror_snapshot::RemoveImageStateRequest<>::create(
      ictx, 123, &cond);
    req->send();
    ASSERT_EQ(0, cond.wait());
  }
